...
function MuiStyledSecondaryQuestionLabelRaw(props) {
...
const MuiStyledSecondaryQuestionLabel = withStyles(styles)(MuiStyledSecondaryQuestionLabelRaw);
export default MuiStyledSecondaryQuestionLabel;
